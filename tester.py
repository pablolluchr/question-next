...
def checkQuestion(questionAnswers,rightAnswer):
    ...
    if(answer == rightAnswer):
        ...
        if printFailedQuestions:
            failed_questions =open("question_sets/failed_questions.txt", "a")
...
if action == "accuracy": #check accuracy over all tests in test_sets
    ...
    try:
        ...
        test_set_number = 1
        test_sets =open("question_sets/test_sets.txt", "r")
...
if action == "newset": #Parse full game into set of questions and saves it in test_sets.txt
    new_set_file = open("question_sets/new_test_set.txt", "r")
    ...
    #write to test_sets
    # try:
    test_sets = open("question_sets/test_sets.txt", "a")
    test_sets.write("[")
